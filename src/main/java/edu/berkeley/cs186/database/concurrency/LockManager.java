...
public class LockManager {
    ...
    private class ResourceEntry {
         ...
         * the resource.
         */
        private boolean checkCompatible(LockType lockType, long except) {
            for (Lock lock : locks) {
        ...
        /**
         * Gives the transaction the lock `newLock`. Assumes that the lock is
         * compatible. Updates lock on resource if the transaction already has a
         * lock.
         */
        private void grantOrUpdateLock(Lock newLock) {
            for (Lock lock : locks) {
         ...
         * the end otherwise.
         */
        private void addToQueue(LockRequest request, boolean addFront) {
            if (addFront) {
